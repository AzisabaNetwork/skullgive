...
public class Remakeskullcommand implements CommandExecutor {

    private final Remakeskull plugin;

    public Remakeskullcommand(Remakeskull remakeskull) {
        this.plugin = remakeskull;
    }
